...
exports.getStoresByTag = async (req, res) => {
    ...
    res.render('tag', { tags, title: 'Tags', currentTag: tag, stores });
}
...
exports.heartStore = async (req, res) => {
    ...
    const operator  = hearts.includes(req.params.id) ? '$pull' : '$addToSet'; // addToSet will not add duplicates, as opposed to push
